...
function processOrder() {
    ...
    if (!meja || !hp) return alert("Harap isi data meja dan nomor HP!");
    ...
    let payDetail = payment === "QRIS" ? "<p>Scan QR di Kasir</p>" : payment === "Transfer Bank" ? "<p>BCA: 12345678</p>" : "<p>Bayar di Kasir</p>";
